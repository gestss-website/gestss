  ...
  useEffect(() => {
    const updatePath = () => {
      if (containerRef.current && fromRef.current && toRef.current) {
        ...
        // Clean boundary docking between elements
        let startX, endX
        if (rectA.right <= rectB.left) {
          // A is on the left of B: dock from A right edge to B left edge
          ...
          // A is on the right of B: dock from A left edge to B right edge
          startX = rectA.left - containerRect.left + startXOffset
          endX = rectB.right - containerRect.left + endXOffset
        } else {
          // Stacked vertically or overlapping: use center
        ...
        // Clean, smooth, non-tangling quadratic curve with curvature offset at midpoint
