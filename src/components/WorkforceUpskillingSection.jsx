...
export default function WorkforceUpskillingSection() {
  ...
  return (
    <section id="upskilling" className="py-12 lg:py-16 bg-white relative overflow-hidden border-t border-slate-200/70">
      {/* Domain-specific battery storage (BESS) & wind cluster vector backdrop (visible on desktop) */}
      <BatteryStorageBESSArt className="hidden sm:block absolute sm:top-6 sm:right-10 sm:w-60 sm:h-36 opacity-40 sm:opacity-45" />
      <WindTurbinesClusterArt className="hidden sm:block absolute sm:bottom-4 sm:left-10 sm:w-52 sm:h-38 opacity-35 sm:opacity-40" />
