    ...
    <section id="why-us" className="py-12 lg:py-16 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full pb-4 pt-1">
          <div 
            ref={containerRef}
            className="relative flex h-[550px] xs:h-[570px] sm:h-[580px] lg:h-[620px] w-full items-center justify-between p-0.5 sm:p-4 md:p-6 overflow-visible"
          >
            {/* Ambient Glow */}
            ...
            <div className="flex flex-col justify-between h-full py-1 sm:py-4 z-10 w-[136px] xs:w-[150px] sm:w-64 md:w-80 shrink-0">
              {/* Card 1 */}
              <div 
                ref={card1Ref}
                className="w-full p-2.5 sm:p-4 rounded-xl sm:rounded-2xl bg-white border border-slate-200/90 shadow-md sm:shadow-lg shadow-slate-900/5 hover:shadow-xl hover:border-emerald-400 transition-all duration-300 flex items-start gap-2 sm:gap-3.5 group cursor-pointer"
              >
                ...
                <div className="min-w-0">
                  <span className="text-sm font-bold text-slate-900 block group-hover:text-emerald-700 transition-colors leading-tight">
                    {pillars[0].title}
                  </span>
                  <p className="text-sm text-slate-600 font-normal leading-snug sm:leading-relaxed mt-1 line-clamp-3 sm:line-clamp-none">
                    {pillars[0].desc}
                  </p>
                </div>
              </div>
              ...
              <div 
                ref={card2Ref}
                className="w-full p-2.5 sm:p-4 rounded-xl sm:rounded-2xl bg-white border border-slate-200/90 shadow-md sm:shadow-lg shadow-slate-900/5 hover:shadow-xl hover:border-blue-400 transition-all duration-300 flex items-start gap-2 sm:gap-3.5 group cursor-pointer"
              >
                ...
                <div className="min-w-0">
                  <span className="text-sm font-bold text-slate-900 block group-hover:text-blue-700 transition-colors leading-tight">
                    {pillars[1].title}
                  </span>
                  <p className="text-sm text-slate-600 font-normal leading-snug sm:leading-relaxed mt-1 line-clamp-3 sm:line-clamp-none">
                    {pillars[1].desc}
              ...
              <div 
                ref={card3Ref}
                className="w-full p-2.5 sm:p-4 rounded-xl sm:rounded-2xl bg-white border border-slate-200/90 shadow-md sm:shadow-lg shadow-slate-900/5 hover:shadow-xl hover:border-amber-400 transition-all duration-300 flex items-start gap-2 sm:gap-3.5 group cursor-pointer"
              >
                ...
                <div className="min-w-0">
                  <span className="text-sm font-bold text-slate-900 block group-hover:text-amber-700 transition-colors leading-tight">
                    {pillars[2].title}
                  </span>
                  <p className="text-sm text-slate-600 font-normal leading-snug sm:leading-relaxed mt-1 line-clamp-3 sm:line-clamp-none">
                    {pillars[2].desc}
            ...
            <div className="flex flex-col items-center justify-center z-10 px-1 sm:px-4 shrink-0">
              ...
              <span className="mt-1 sm:mt-3 px-1.5 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs sm:text-[10px] font-black uppercase tracking-wider bg-emerald-100 text-emerald-900 border border-emerald-300/80 shadow-sm whitespace-nowrap">
                GESTSS Engine
              </span>
            </div>
