    ...
    <section id="stakeholders" className="py-12 lg:py-16 bg-white relative overflow-hidden border-t border-slate-200/70">
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-14">
          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-bold font-display text-slate-900 tracking-tight">
          ...
          <div className="p-3.5 sm:p-8 lg:p-12 rounded-2xl sm:rounded-3xl bg-slate-950 text-white shadow-2xl flex flex-col justify-between relative overflow-hidden border border-slate-800 group">
            ...
            <div className="space-y-3 sm:space-y-6 relative z-10">
              <div className="flex items-center justify-between gap-1">
                ...
                <span className="text-[8px] sm:text-[11px] font-bold uppercase tracking-wider text-emerald-400 bg-emerald-950/80 px-2 py-0.5 sm:px-3 sm:py-1 rounded-full border border-emerald-500/30 flex items-center gap-1 shrink-0">
              ...
              <p className="text-[10px] sm:text-base lg:text-lg text-slate-200 leading-relaxed font-normal">
              ...
              <p className="text-[9px] sm:text-sm lg:text-base text-slate-400 leading-relaxed font-normal">
            ...
            <div className="mt-4 sm:mt-8 pt-3 sm:pt-6 border-t border-slate-800 relative z-10">
              <button
                ...
                className="w-full py-2 sm:py-3.5 px-2 sm:px-8 rounded-xl sm:rounded-full font-bold text-[10px] sm:text-sm text-slate-950 bg-emerald-400 hover:bg-emerald-300 transition-all flex items-center justify-center gap-1.5 shadow-lg"
              >
          ...
          <div className="p-3.5 sm:p-8 lg:p-12 rounded-2xl sm:rounded-3xl bg-slate-50 border border-slate-200/90 shadow-lg hover:shadow-xl transition-all flex flex-col justify-between relative overflow-hidden group">
            <div className="space-y-3 sm:space-y-6">
              <div className="flex items-center justify-between gap-1">
                ...
                <span className="text-[8px] sm:text-[11px] font-bold uppercase tracking-wider text-gestss-green-900 bg-emerald-100 px-2 py-0.5 sm:px-3 sm:py-1 rounded-full border border-emerald-200 flex items-center gap-1 shrink-0">
              ...
              <p className="text-[10px] sm:text-base lg:text-lg text-slate-800 leading-relaxed font-normal">
              ...
              <p className="text-[9px] sm:text-sm lg:text-base text-slate-600 leading-relaxed font-normal">
            ...
            <div className="mt-4 sm:mt-8 pt-3 sm:pt-6 border-t border-slate-200/80">
              <button
                ...
                className="w-full py-2 sm:py-3.5 px-2 sm:px-8 rounded-xl sm:rounded-full font-bold text-[10px] sm:text-sm text-white bg-slate-900 hover:bg-slate-800 transition-all flex items-center justify-center gap-1.5 shadow-md"
              >
