...
export default function ServicesGrid({ onRequestTalent }) {
  ...
  return (
    <section id="services" className="py-12 lg:py-16 bg-slate-50 relative overflow-hidden">
      ...
      {/* Domain-specific EV charging & battery storage vector backdrop (visible on desktop) */}
      <EVChargingStationArt className="hidden sm:block absolute sm:top-6 sm:right-12 sm:w-64 sm:h-38 opacity-40 sm:opacity-45" />
      <BatteryStorageBESSArt className="hidden sm:block absolute sm:bottom-3 sm:left-10 sm:w-60 sm:h-34 opacity-35 sm:opacity-40" />
